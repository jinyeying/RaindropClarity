...
def parse_args_and_config():
    parser = argparse.ArgumentParser(description='Restoring Raindrop Clarity with ICRA256')
    parser.add_argument("--config", type=str, default='nighttime_256.yml',
                        help="Path to the config file")
    parser.add_argument('--resume', default='/home1/yeying/release/RDiffusion/Param/NightRaindrop/ICRA256/epoch400.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='ICRA256',
                        help="restoration test set results: ['Raindrop_DiT', 'RDiffusion', 'IDT', 'restormer', 'Uformer', 'ICRA256', 'onego', 'atgan']")
    parser.add_argument("--image_folder", default='results111/', type=str,
