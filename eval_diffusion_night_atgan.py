...
def parse_args_and_config():
    parser = argparse.ArgumentParser(description='Restoring Raindrop Clarity with atgan')
    parser.add_argument("--config", type=str, default='nighttime_256.yml',
                        help="Path to the config file")
    parser.add_argument('--resume', default='/home1/yeying/release/RDiffusion/Param/NightRaindrop/atgan/epoch100.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='atgan',
