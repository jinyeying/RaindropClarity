...
def parse_args_and_config():
    ...
    parser.add_argument("--config", type=str, default='daytime_128.yml',
                        help="Path to the config file")
    parser.add_argument('--resume', default='/home1/yeying/release/RDiffusion/Param/RainDrop/restormer/epoch100.pth.tar', type=str,
    ...
    parser.add_argument("--test_set", type=str, default='restormer',
